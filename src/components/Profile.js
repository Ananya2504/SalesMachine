        ...
        <div className="left">
            <div className="profile">
                <div className="top">
                    <div className="intro">
                        ...
                        <div className="info"> 
                                ...
                                <p className="comp-name"><strong>Ringover  |  <PeopleIcon /> 101-250</strong></p>
                                <a href="http://www.ringover" className="web">http://www.ringover</a>
                        </div>
                    </div>
                ...
                <div className="topics">
                    ...
                    <div className="flex">
                        <button className="btns">Some Topic</button>
                        <button className="btns">Some Topic Name</button>
                    </div>
                </div>

                <div className="contact">
                    <h5 className="topic">Contact</h5>
                    <p><EmailIcon /> example@ringover.com</p>
                    <p><PhoneIcon /> +33 56787 89076</p>
                    <p><PhoneIcon /> +33 89080 34578</p>
                </div>

                <div className="add">
                    <h5 className="topic">Additionals</h5>
                    <p><EmailIcon /> president@ringover.com</p>
                    <p><TranslateIcon /> Francis</p>
                    <p><LinkIcon /> www.youtube.com/ringover</p>
                    <p><LanguageIcon /> Indian Standard (+5:30)</p>
                </div>
            ...
            <div className="work">
                ...
                <div className="row work-top">
                    ...
                    <div className="col-6 d-flex justify-content-end">
                        <div className="d-flex justify-content-around work-icons">
                          <RecordVoiceOverIcon />
                          <NoteIcon />
                        </div>   
                    </div>
                ...
                <div className="row">
                    <div className="col">
                        ...
                        >
                        <h5>Your WorkS pace is Empty</h5>
                        <p>Add tabs to have a view!</p>
                        </div>
                        ...
                        >
                        <h5>Oops! Max Size reached, Close some tabs to add new ones!</h5>
                        </div>
